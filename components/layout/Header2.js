...
export default function Header2({
  ...
  return (
    <>
      <header
        className={`main-header header-style-two outer-box-position ${isSearch ? 'moblie-search-active' : ''}`}
      >
        {/* Header Top */}
          ...
          <div className="inner-container">
            ...
            <div className="top-right">
              ...
              <ul className="list-style-one">
                <li>
                  <i className="fa fa-map-marker-alt"></i> Richardson,
                  California 62639, USA{' '}
                </li>
                <li>
                  <i className="fa fa-envelope"></i>{' '}
                  <Link href="mailto:transtex@mail.com">
                    voyacht@domain.com
                  </Link>
                </li>
              </ul>
        ...
        {/* Header Top */}
        <div className="header-lower light">
          {/* Main box */}
          <div className="main-box">
            <div className="logo-box">
              <div className="logo">
                <Link href="/">
                  <img src="/images/logo-3.png" alt="Logo" title="Voyacht" />
                </Link>
              </div>
            </div>
            ...
            <div className="outer-box">
              ...
              {/* Btn Box */}
              <div className="btn-box search-btn call-btn">
                {/* Info Btn */}
              ...
              <div className="btn-box">
                <Link
                  href="page-contact"
                  className="theme-btn btn-style-two hover-dark"
                >
